...
import com.alex.minhasfinancas.model.repository.LancamentoRepository;
...
public class LancamentoServiceImpl implements LancamentoService{
	...
	public void validar(Lancamento lancamento) {
		...
		// o trim é para retirar os espaços antes e depois da string digitada.
		...
		if(lancamento.getUsuario() == null || lancamento.getUsuario().getId() == null) {
			throw new RegraNegocioException("Informe umUsuário.");
